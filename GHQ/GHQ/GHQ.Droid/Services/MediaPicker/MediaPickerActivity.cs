...
namespace GHQ.Droid.Services.Helpers
{
    /// <summary>
        ...
        : Activity
    {
            ...
            bool isPhoto, Uri data)
        {
            ...
            if (filePath != null && imageSize != -1)
            {
                ...
                {
                    MediaPickedEventArgs args = new MediaPickedEventArgs(requestCode, new AttachmentSizeException("AttachFileException - Too Large",imageSize));
                    return args;
                }
                ...
                try
                {
                    ...
                    if (bytes != null)
                    {
                        var mf = new MediaFile() { data = bytes, Extension = filePath };
