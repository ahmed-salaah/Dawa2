...
namespace Controls
{
    public partial class PickerButtonField : ContentView
    {
        ...
        public static readonly BindableProperty HorizontalTextAlignmentProperty = BindableProperty.Create<PickerButtonField, TextAlignment>(p => p.HorizontalTextAlignment, TextAlignment.Start);
